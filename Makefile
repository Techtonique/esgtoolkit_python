...
coverage: ## check code coverage quickly with the default Python
	coverage run --source esgtoolkit setup.py test
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate mkdocs
	cd esgtoolkit-docs&&mkdocs build&&cd ..

servedocs: docs## compile the docs watching for changes
	cd esgtoolkit-docs&&mkdocs serve&&cd ..
...
build-site: docs ## export mkdocs website to a folder
	...
	cp -rf docs/site/* ../../Pro_Website/Techtonique.github.io/esgtoolkit
	cd ..
